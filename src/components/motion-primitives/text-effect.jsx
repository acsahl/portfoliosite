// Ported from motion-primitives (https://motion-primitives.com/docs/text-effect),
// stripped of TypeScript types and the shadcn `cn` helper (inlined below)
// since this project isn't set up with either.
